...
alter table Pago add Tipo_Tarjeta varchar(60);
...
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (1, 1, 'Burty', '3584750692751389', '2020/04/27', 1, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (2, 2, 'Carter', '5428582799396619', '2020/05/12', 2, 'mastercard');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (3, 3, 'Lenette', '374288550227358', '2019/07/03', 3, 'americanexpress');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (4, 4, 'Adel', '3567351004561797', '2020/05/24', 4, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (5, 5, 'Brianne', '4917205721503323', '2019/10/09', 5, 'visa-electron');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (6, 6, 'Caleb', '3533399528275932', '2020/03/28', 6, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (7, 7, 'Kenyon', '6389233736658431', '2020/03/17', 7, 'instapayment');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (8, 8, 'Gal', '5020563784170088752', '2019/11/30', 8, 'maestro');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (9, 9, 'Burnard', '3529305401498661', '2020/04/27', 9, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (10, 10, 'Gareth', '5048375053082573', '2019/12/06', 10, 'mastercard');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (11, 11, 'Lilia', '201866913999810', '2019/11/03', 11, 'diners-club-enroute');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (12, 12, 'Luther', '30204771778125', '2020/01/27', 12, 'diners-club-carte-blanche');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (13, 13, 'Bear', '3549509315852592', '2019/11/02', 13, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (14, 14, 'West', '4844087407347680', '2020/04/07', 14, 'visa-electron');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (15, 15, 'Cristabel', '4917543436250156', '2019/11/16', 15, 'visa-electron');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (16, 16, 'Mara', '3557850100528297', '2019/10/28', 16, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (17, 17, 'Reider', '3529999055879430', '2020/03/13', 17, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (18, 18, 'Padget', '30535017959015', '2019/09/21', 18, 'diners-club-carte-blanche');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (19, 19, 'Wilmer', '30551716764879', '2019/06/09', 19, 'diners-club-carte-blanche');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (20, 20, 'Tracy', '3586368383928865', '2020/02/14', 20, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (21, 21, 'Gabriele', '3540979999226992', '2020/03/25', 21, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (22, 22, 'Octavius', '56022505457318107', '2020/01/30', 22, 'china-unionpay');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (23, 23, 'Abigael', '3563777204657544', '2020/03/17', 23, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (24, 24, 'Alva', '30137027535024', '2019/08/28', 24, 'diners-club-carte-blanche');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (25, 25, 'Becca', '5399687732492261', '2020/05/18', 25, 'mastercard');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (26, 26, 'Aurelia', '3574820065763758', '2020/01/26', 26, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (27, 27, 'Denny', '6387577322661163', '2019/08/01', 27, 'instapayment');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (28, 28, 'Zachary', '3556923883504305', '2020/05/19', 28, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (29, 29, 'Niki', '3583456613032807', '2019/11/19', 29, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (30, 30, 'Marline', '3573511923356536', '2019/11/27', 30, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (31, 31, 'Walden', '30233896578029', '2019/12/17', 31, 'diners-club-carte-blanche');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (32, 32, 'Simon', '5602235640680172', '2020/04/24', 32, 'bankcard');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (33, 33, 'Jacinda', '6388926856317156', '2019/09/22', 33, 'instapayment');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (34, 34, 'Lisabeth', '3547443312667252', '2020/03/18', 34, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (35, 35, 'Melonie', '4041599117820278', '2019/07/03', 35, 'visa');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (36, 36, 'Myles', '5374280730395717', '2019/08/09', 36, 'mastercard');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (37, 37, 'Malissa', '3560126033117754', '2020/04/21', 37, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (38, 38, 'Tann', '5602238534918674', '2020/03/25', 38, 'bankcard');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (39, 39, 'Beauregard', '30219896038635', '2019/06/02', 39, 'diners-club-carte-blanche');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (40, 40, 'Roshelle', '3585718208802318', '2020/05/11', 40, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (41, 41, 'Franzen', '3541463466592029', '2019/10/28', 41, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (42, 42, 'Phillida', '4431692939732', '2019/11/20', 42, 'visa');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (43, 43, 'Bevan', '6759547327667179412', '2019/06/01', 43, 'maestro');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (44, 44, 'Robbie', '201780901878938', '2019/12/29', 44, 'diners-club-enroute');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (45, 45, 'Clarette', '3554255037896739', '2019/10/06', 45, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (46, 46, 'Sheilakathryn', '3532014839385210', '2019/11/12', 46, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (47, 47, 'Donnie', '5256712035189539', '2019/07/03', 47, 'mastercard');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (48, 48, 'Joey', '3563215938482954', '2020/03/13', 48, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (49, 49, 'Frasco', '4017957432656498', '2019/11/18', 49, 'visa');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (50, 50, 'Opaline', '3581088060149198', '2019/06/26', 50, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (51, 51, 'Cassi', '5602220860770186459', '2019/12/15', 51, 'china-unionpay');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (52, 52, 'Torrance', '201446515867580', '2019/07/19', 52, 'diners-club-enroute');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (53, 53, 'Ernesta', '3587555188237034', '2019/07/01', 53, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (54, 54, 'Haslett', '5100760374516398', '2019/07/18', 54, 'mastercard');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (55, 55, 'Sloan', '30125920643029', '2019/06/17', 55, 'diners-club-carte-blanche');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (56, 56, 'Judd', '3559461925385497', '2020/04/12', 56, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (57, 57, 'Mabelle', '36794711538203', '2019/08/14', 57, 'diners-club-international');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (58, 58, 'Dodi', '3560616244118435', '2019/10/26', 58, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (59, 59, 'Parsifal', '5108756312283978', '2019/06/13', 59, 'mastercard');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (60, 60, 'Mella', '4917232500196194', '2019/12/19', 60, 'visa-electron');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (61, 61, 'Wilhelmina', '5602224627036947', '2019/07/09', 61, 'bankcard');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (62, 62, 'Quincey', '3540559545292217', '2019/10/02', 62, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (63, 63, 'Barron', '5602248288691577267', '2020/04/16', 63, 'china-unionpay');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (64, 64, 'Kayley', '3579228248991780', '2020/05/16', 64, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (65, 65, 'Lira', '5007665094315183', '2019/11/16', 65, 'mastercard');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (66, 66, 'Annadiana', '677127533074792295', '2019/11/19', 66, 'laser');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (67, 67, 'Fabiano', '5183325126651115', '2019/11/20', 67, 'mastercard');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (68, 68, 'Meredith', '5893512055176193694', '2020/01/18', 68, 'maestro');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (69, 69, 'Dunn', '5610283221488862', '2019/10/09', 69, 'bankcard');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (70, 70, 'Sherye', '6763360456325952', '2019/07/25', 70, 'maestro');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (71, 71, 'Consuelo', '3552854189392638', '2019/08/08', 71, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (72, 72, 'Feodora', '3541191524833107', '2019/08/23', 72, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (73, 73, 'Consolata', '6759941279074451482', '2020/05/03', 73, 'maestro');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (74, 74, 'Helenka', '3534376842322557', '2019/06/20', 74, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (75, 75, 'Dana', '6373737436872736', '2020/03/29', 75, 'instapayment');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (76, 76, 'Kirsteni', '3554354156787165', '2019/10/15', 76, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (77, 77, 'Erminia', '4911945228846685', '2020/03/16', 77, 'switch');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (78, 78, 'Scarlet', '3581844330258098', '2020/03/01', 78, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (79, 79, 'Karin', '5602244481551021', '2020/04/07', 79, 'bankcard');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (80, 80, 'Cherry', '5602221793070122', '2020/02/23', 80, 'bankcard');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (81, 81, 'Maryjo', '6395192523216906', '2020/05/14', 81, 'instapayment');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (82, 82, 'Dieter', '5100179006458137', '2019/10/25', 82, 'mastercard');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (83, 83, 'Roberto', '4041373157213', '2019/06/19', 83, 'visa');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (84, 84, 'Cyndy', '0604775505650355', '2019/10/24', 84, 'maestro');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (85, 85, 'Devon', '3552364455276168', '2019/11/12', 85, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (86, 86, 'Paulie', '3557239228330093', '2019/12/24', 86, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (87, 87, 'Mickie', '3589632209595381', '2019/11/15', 87, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (88, 88, 'Heriberto', '5602210681560717580', '2020/03/17', 88, 'china-unionpay');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (89, 89, 'Pauli', '3538014138413428', '2020/05/20', 89, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (90, 90, 'Paddy', '3581502989237835', '2020/02/27', 90, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (91, 91, 'Olivette', '5569423571703574', '2019/12/12', 91, 'diners-club-us-ca');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (92, 92, 'Pate', '3554560787862017', '2019/08/26', 92, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (93, 93, 'Laural', '3580122449951361', '2019/12/20', 93, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (94, 94, 'Nissy', '5002351038445478', '2019/07/11', 94, 'mastercard');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (95, 95, 'Andonis', '3567106275658726', '2019/09/15', 95, 'jcb');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (96, 96, 'Jenn', '56022522003299996', '2020/02/24', 96, 'china-unionpay');
insert into Pago (Id_Pago, Id_Usuario, Nombre_PTarjeta, Numero_Tarjeta, Fecha_Vencimiento, codigo_Seguridad_, Tipo_Tarjeta) values (97, 97, 'Veda', '3570763377110025', '2020/01/30', 97, 'jcb');
...
#generacion de datos para las canciones escuchadas
